...
plot(density(openinfo_qual$BUGSoutput$sims.list$beta_rel_mom))
plot(density(openinfo_qual$BUGSoutput$sims.list$beta_ip_mom))
plot(density(openinfo_qual$BUGSoutput$sims.list$beta_mom))
...
theta_q_post <- openinfo_qual$BUGSoutput$sims.list$theta_q_mom
